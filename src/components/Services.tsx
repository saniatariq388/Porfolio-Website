...
function Services() {
  return (
    <>
      <section id="services" className="py-40 px-2 md:px-8 bg-[#001F3F]">
        <div className="text-center">
          <h4 className="text-white text-4xl lg:text-5xl font-[Caveat]">
            <span className="">
              <span className="text-[#EAD8B1]">W</span>hat{" "}
              <span className="text-[#EAD8B1]">I</span>{" "}
              <span className="text-[#EAD8B1]">D</span>o{" "}
              <span className="text-[#EAD8B1]">F</span>or{" "}
              <span className="text-[#EAD8B1] capitalize">C</span>lients
            </span>
          </h4>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-4 text-start">
            ...
            <div className="rounded-xl py-6 px-4 bg-[#3A6D8C] flex flex-col justify-between items-center cursor-pointer transition-all duration-[1.2s] hover:bg-[#6A9AB0]">
