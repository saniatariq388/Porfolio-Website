...
function AboutSection() {
  return (
    <>
      <section id='about' className='w-full py-[160px] px-10 bg-[#003161] flex flex-col md:flex-row justify-center'>
        
        <div className='mx-auto w-[50%] px-[16px] flex flex-col items-start text-left'>
          <p className={`${caveat.className} text-[48px]`}>Sania Tariq</p>
          
          <p className={`${caveat.className} text-[30px] mt-2 mb-6 text-light-beige text-center lg:text-start text-3xl text-[#EAD8B1]`}>Freelance Web Developer</p>
      ...
      <section className="w-full py-5 px-5 mx-auto flex justify-center items-center gap-16 bg-[#000B58] overflow-hidden">
