...
function Contact() {
  return (
    <>
      <section id="contact" className="py-40 px-4 md:px-8 bg-[#001F3F]">
        <div className="text-center text-white">
          <h4 className="text-4xl lg:text-5xl font-[Caveat]">
            <span>
              <span className="text-[#EAD8B1] ">C</span>ontact{' '}
              <span className="text-[#EAD8B1] ">M</span>e
            </span>
          </h4>
          ...
          <div className="mt-24 flex flex-col lg:flex-row justify-evenly items-start">
            ...
            <div className="flex flex-col justify-center items-start text-center">
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="text-[#EAD8B1] ">Email me at sania.tariq@mail.com</p>
                </div>
              </div>
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="text-[#EAD8B1] ">serving clients worldwide</p>
                </div>
              </div>
            ...
            <form className="w-full lg:w-[50%] flex flex-col items-start">
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
                <input
                  className="p-3 my-4 rounded-lg bg-[#3A6D8C] text-white placeholder: focus:outline-0"
                  type="text"
                  name="name"
                  id="name"
              ...
              <div className="w-full">
                <input
                  className="p-3 my-4 rounded-lg bg-[#3A6D8C] text-white placeholder: focus:outline-0 w-full"
                  type="text"
                  name="subject"
                  id="subject"
                  placeholder="Subject"
                ...
                <textarea
                  id="msg"
                  className="p-3 my-4 rounded-lg bg-[#3A6D8C] text-white placeholder: focus:outline-0 w-full min-h-[14rem]"
                  placeholder="Your message"
                  autoComplete="off"
                />
              </div>

              <Link href="#home" className="py-3 px-8 rounded-lg text-lg text-white bg-[#3A6D8C] transition hover:bg-[#3A6D8C]  mt-4">
                Send message
              </Link>
            </form>
          </div>
