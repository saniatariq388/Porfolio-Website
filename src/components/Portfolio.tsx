...
function Portfolio() {
  return (
    <>
      <section id="portfolio" className="w-full py-36 px-8 text-center bg-[#001F3F]">
        <h4 className={`${caveat.className} text-white text-4xl lg:text-5xl`}>
          <span className="text-[#EAD8B1]">M</span>y{" "}
          <span className="text-[#EAD8B1]">L</span>ast{" "}
          <span className="text-[#EAD8B1]">W</span>ork
        </h4>
