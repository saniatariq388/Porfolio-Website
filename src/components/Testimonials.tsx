...
function Testimonials() {
  return (
   <>
     <section id="testimonials" className="bg-[#001F3F] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-[#EAD8B1]">W</span>hat{' '}
            <span className="text-[#EAD8B1]">O</span>ther{' '}
            <span className="text-[#EAD8B1]">P</span>eople{' '}
            <span className="text-[#EAD8B1]">S</span>ay
          </span>
        </h4>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="mx-auto py-8 px-2 md:px-4 border-t-[3px] border-solid border-light-beige rounded-2xl select-none bg-[#3A6D8C] cursor-grab flex flex-col justify-center items-center"
              >
                ...
                <p className="my-4 text-[#EAD8B1]">{person.role}</p>
